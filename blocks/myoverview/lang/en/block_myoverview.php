...
$string['nocoursestimeindependent'] = 'No time independent courses';
...
$string['timeindependent'] = 'Time independent';
$string['timeindependent_desc'] = 'Show a separate tab for courses with no end date set.';
